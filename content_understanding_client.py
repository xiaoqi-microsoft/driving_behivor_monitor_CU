...
class AzureContentUnderstandingClient:
    ...
    def begin_analyze(self, analyzer_id: str, file_location: str):
        ...
        """
        # Inside begin_create_analyzer before sending the request  
        print("Request URL:", self._get_analyzer_url(self._endpoint, self._api_version, analyzer_id))  
        print("Request Headers:", headers)  
        #print("Request Payload:", json.dumps(analyzer_template, indent=2))  
